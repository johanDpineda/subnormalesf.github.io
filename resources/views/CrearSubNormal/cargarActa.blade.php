<div wire:ignore.self  class="modal fade" id="cargarActa"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content p-3 p-md-5">
            ...
            <div class="modal-body">
                ...
                <div class="text-center mb-4">
                    <h3 class="mb-2">{{__('Add Document Representative Minutes')}}</h3>
                    <p class="text-muted">{{__('Complete the information to add the Representatives Minutes')}}</p>
                </div>
                ...
                @if($doclideer)
                    @livewire("crear-subnormal.archivolider", ['doclideer' => $doclideer])
                @endif
