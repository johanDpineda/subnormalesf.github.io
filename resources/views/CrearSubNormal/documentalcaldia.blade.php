<div wire:ignore.self  class="modal fade" id="cargarCertificado"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-simple ">
        <div class="modal-content p-3 p-md-5">
            ...
            <div class="modal-body">
                ...
                {{-- Antes de pasar $creacionsubnormals al modal, verifica si tiene datos --}}
                ...
                @if($docAlcaldiaa)
                    @livewire("crear-subnormal.archivoalcaldia", ['docAlcaldiaa' => $docAlcaldiaa])
                @endif
