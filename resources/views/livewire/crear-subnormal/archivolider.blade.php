<div>
    <form class="row g-3" wire:submit.prevent="save">
        ...
        <div class="col-12">
            <label class="form-label" for="file_name_actalider">* {{__('Representative Minutes')}}:</label>
            <input type="file" wire:model="file_name_actalider" class="form-control">
            @error('file_name_actalider')
