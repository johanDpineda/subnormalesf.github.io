                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        @if ($selectedCaminante)
                            <iframe src='https://www.google.com/maps?q={{ $selectedCaminante->latitude ?? "" }},{{ $selectedCaminante->longitude ?? "" }}&hl=es;z=14&output=embed' frameborder="0" width="450" height="450"></iframe>
