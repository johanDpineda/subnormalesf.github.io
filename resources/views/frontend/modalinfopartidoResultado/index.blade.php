                                        ...
                                        <a href="">
                                            <div class="cluboficialesop2">
                                                ...
                                                @else
                                                    ...
                                                    @php
                                                        $imagenes = File::allFiles(public_path('uploads/logoteams/'));
                                                        $imagenAleatoriaresulmodal = collect($imagenes)->random();
                                                    @endphp

                                                    @if ($imagenAleatoriaresulmodal)
                                                        <img src="{{ asset('uploads/logoteams/' . $imagenAleatoriaresulmodal->getFilename()) }}" alt="Descripción de la imagen" class="iconclubesliga size-xs">
                                                        <div class="textoequipo2">
