<div class="modal fade animate__animated fadeIn" id="animationModalpos{{$goleador->player_id }}" tabindex="-1" aria-hidden="true">
                ...
                <div class="player-info row align-items-center">
                    <div class="col-md-6">
                        @if($goleador->player->profile_photo!=null)
                            ...
                            <div class="player-photoperfilpos">
                                <img src="{{asset('uploads/players/'.$goleador->player->profile_photo) }}"
                    ...
                    <div class="col-md-6">
                        <div class="player-details w-100">
                            ...
                            <div class="details-row">
                                <div class="details-cell">
                                    <p style="color: #d3fe00;"><span class="letramodaljugador">Posición:</span> <span class="info-player">{{ $goleador->player->position->name }}</span> </p>
                                </div>
                                <div class="details-cell">
                                    <p style="color: #d3fe00;"><span class="letramodaljugador">Altura:</span> <span class="info-player">{{ $goleador->player->height }} cm</span> </p>
                                </div>
                            </div>
                            <div class="details-row">
                                <div class="details-cell">
                                    <p style="color: #d3fe00;"><span class="letramodaljugador">Peso:</span> <span class="info-player">{{ $goleador->player->weight }} kg</span> </p>
                                </div>
                                @php
                                    $anioActual = date('Y');
                                    $anioNacimiento = date('Y', strtotime($goleador->player->birth_date));
                                    $edad = $anioActual - $anioNacimiento;

                                    if (date('md', strtotime($goleador->player->birth_date)) > date('md')) {
                    ...
                    <div class="stats-containerstatics">
                        <div class="statperfilmodalplayer">
                            ...
                            <div class="contendordatosstatics">
                                ...
                                {{ $goleador->player->scorerMatches->where('tournament_id', $tournament->id)->whereNotNull('goals')->sum('goals') }}
                            </div>
                        ...
                        <div class="statperfilmodalplayer">
                            ...
                            <div class="contendordatosstatics">
                                ...
                                {{ $goleador->player->scorerMatches->where('tournament_id', $tournament->id)->whereNotNull('yellow')->sum('yellow') }}
                            </div>
                            <div class="titulodatosstactics">
                                Amarillas
                            </div>
                        ...
                        <div class="statperfilmodalplayer">
                            ...
                            <div class="contendordatosstatics">
                                ...
                                {{ $goleador->player->scorerMatches->where('tournament_id', $tournament->id)->whereNotNull('red')->sum('red') }}
                            </div>
                            <div class="titulodatosstactics">
                                Rojas
                            </div>
