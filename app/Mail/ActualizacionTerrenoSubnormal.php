...
class ActualizacionTerrenoSubnormal extends Mailable
{
    use Queueable, SerializesModels;
    public $subject = 'Notificación de Actualización de Registro de zona subnormal';
    public $data;
    public $terreno;
    ...
    public function build()
    {
        ...
        return $this->view('emails.ActualizaciondeTerrenoSubnormal', $data);
    }
}
